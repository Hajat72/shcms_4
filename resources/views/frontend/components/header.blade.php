                    ...
                    <div class="col-lg-3">
                        <div class="header-action-items-layout1">
                            <ul>
                                ...
                                <li class="cart-area-dark">
                                    ...
                                    <div class="cart-items">
                                        <div class="cart-item">
                                            <div class="cart-img">
                                                <a href="#">
                                                    <img src="{{asset('frontend/img/shop/cart1.png')}}" alt="product" class="img-fluid">
                                                </a>
                                            </div>
                                        ...
                                        <div class="cart-item">
                                            <div class="cart-img">
                                                <a href="#">
                                                    <img src="{{asset('frontend/img/shop/cart2.png')}}" alt="product" class="img-fluid">
                                                </a>
                                            </div>
                                            <div class="cart-title">
                                        ...
                                        <div class="cart-item">
                                            <div class="cart-img">
                                                <a href="#">
                                                    <img src="{{asset('frontend/img/shop/cart3.png')}}" alt="product" class="img-fluid">
                                                </a>
                                            </div>
                                            <div class="cart-title">
                                                <a href="#">Microscope</a>
                                ...
                                <li>
                                    <a href="#" class="action-items-primary-btn ml-3">Appointment</a>
                                </li>
                            </ul>
                        </div>
                    </div>
